    ...
    <div class="p-6 sm:p-4 mt-6 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
        ...
        <div class="px-4 py-8">
            ...
            <div x-cloak x-data="{ open: @entangle('showModal') }" x-show="open" class="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
                ...
                <div class="bg-white dark:bg-gray-800 p-5 rounded-lg shadow-lg w-2/5">
                    ...
                    <form wire:submit.prevent="submit" class="space-y-6">
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input wire:model="status" id="status" class="block mt-1 w-full" type="text" name="status"/>
                        </div>
                      
                        <div class="flex items-center justify-end mt-4"> 
                       
                            <button class="mt-3 px-4 py-2 bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">{{ $updateMode ? __('Обновить') : __('Создать')}}</button>
